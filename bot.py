...
__version__ = '$Id: 18436db34b2a60d442e65b785c554414e77b5d0e $'
...
def handle_args(args=None, do_help=True):
    ...
    if config.verbose_output:
        ...
        # replacement with `$Id: 18436db34b2a60d442e65b785c554414e77b5d0e $`
        # or `$Id: 18436db34b2a60d442e65b785c554414e77b5d0e $`.
        m = re.search(r"\$Id"
